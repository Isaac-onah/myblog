			...
			<div class="col-lg-8 col-md-6">
				<div class="row">
					<div class="containerzar">
						<div id="slizar">
							<div class="itemzar" style="background-image: url(<?= ROOT ?>/assets/images/img-1.jpg);">
							...
							<div class="itemzar" style="background-image: url(<?= ROOT ?>/assets/images/img-2.jpg);">
								<div class="contentzar">
									<div class="namezar">LUNDEV</div>
									<div class="des">Tinh ru anh di chay pho, chua kip chay pho thi anhchay mat tieu</div>
									<button>See more</button>
							...
							<div class="itemzar" style="background-image: url(<?= ROOT ?>/assets/images/img-3.jpg);">
								<div class="contentzar">
									<div class="namezar">LUNDEV</div>
									<div class="des">Tinh ru anh di chay pho, chua kip chay pho thi anhchay mat tieu</div>
									<button>See more</button>
							...
							<div class="itemzar" style="background-image: url(<?= ROOT ?>/assets/images/img-4.jpg);">
								<div class="contentzar">
									<div class="namezar">LUNDEV</div>
									<div class="des">Tinh ru anh di chay pho, chua kip chay pho thi anhchay mat tieu</div>
									<button>See more</button>
