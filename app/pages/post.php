...
if ($slug) {
    $query = "select posts.*,categories.category, users.username from posts join categories on posts.category_id = categories.id join users on posts.user_id = users.id where posts.slug = :slug limit 1";
                ...
                <div class="col-lg-12 text-center">
                    <div class="page-next-level">
                        ...
                        <ul class="list-unstyled mt-3">
                            ...
                            <li class="list-inline-item me-3"><i class="mdi mdi-account-heart me-1"></i><a href="javascript:void(0)" class="text-muted"><?= esc($row['username'] ?? 'Unknown') ?></a></li>
